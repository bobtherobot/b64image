...
function updateOutAsFields(str, w, h) {
	...
	// CSS Class
	var cssOut = [".embeddedImage" + randomInt(0, 1000) + " {", "	position : relative;", "	display : inline-block;", "	width : " + w + "px;", "	height : " + h + "px;", "	/* Maintain aspect ratio: */", "	background-size : contain;", "	/* Squish to exact width/height: */", "	/* background-size : 100% 100%; */", "	background-repeat : no-repeat;", "	background-position : center center;", "	background-image : url('" + str + "');", "}"];
...
var domready=function(){var e,t=[],n=document,o=n.documentElement.doScroll,
d="DOMContentLoaded",r=(o?/^loaded|^c/:/^loaded|^i|^c/).test(n.readyState);
return r||n.addEventListener(d,e=function(){for(n.removeEventListener(d,e),
r=1;e=t.shift();)e()}),function(e){r?setTimeout(e,0):t.push(e)}}();
